    ...
    return (
        <section className='pt-[120px] md:pt-[160px] pb-20'>
            <div className="container_fluid">
                <div className="w-full md:w-[714px] mx-auto text-center">
                    <SectionHeader lineClass={"right-[31%]"} className={"md:px-16"} header={"Check Out Some Great Case Studies"} subHeader={"Case Study"} />
